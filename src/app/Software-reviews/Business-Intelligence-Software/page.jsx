            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#386861] focus:border-transparent"
                />
...
<div className="mt-10 space-y-6">
  ...
  <div className="bg-white p-6 rounded-xl border shadow-sm">
    <div className="flex items-center justify-between">
      ...
      <a href="#" className="text-[#386861] text-sm font-medium hover:underline">Compare</a>
    </div>
    <h3 className="text-lg font-semibold text-gray-800 mt-2">Angles Enterprise for SAP <span className="text-sm text-[#386861] ml-2">Leave a Review</span></h3>
    ...
    <p className="text-gray-700 text-sm mt-3">
      ...
      <a href="#" className="text-[#386861] font-medium ml-1">Learn More About Angles Enterprise for SAP</a>
    </p>
  ...
  <div className="bg-white p-6 rounded-xl border shadow-sm">
    ...
    <h3 className="text-lg font-semibold text-gray-800 mt-2">Angles Professional <span className="text-sm text-[#386861] ml-2">Leave a Review</span></h3>
    ...
    <p className="text-gray-700 text-sm mt-3">
      ...
      <a href="#" className="text-[#386861] font-medium ml-1">Learn More About Angles Professional</a>
    </p>
    <button className="mt-4 inline-block px-5 py-2 bg-gray-100 text-sm font-medium text-gray-800 rounded-full border hover:bg-gray-200 transition">Visit Product Profile</button>
  </div>
</div>
...
<div className="mt-10 space-y-6">
  ...
  <div className="bg-white p-6 rounded-xl border shadow-sm">
    ...
    <h3 className="text-lg font-semibold text-gray-800 mt-2">
      APISCRAPY 
      <span className="text-[#386861] text-sm font-medium ml-2">★★★★★</span>
    ...
    <p className="text-gray-700 text-sm mt-3">
      ...
      <a href="#" className="text-[#386861] font-medium ml-1">Learn More About APISCRAPY</a>
    </p>
    <button className="mt-4 inline-block px-5 py-2 bg-gray-100 text-sm font-medium text-gray-800 rounded-full border hover:bg-gray-200 transition">Visit Product Profile</button>
  </div>
  ...
  <div className="bg-white p-6 rounded-xl border shadow-sm">
    ...
    <h3 className="text-lg font-semibold text-gray-800 mt-2">
      Ayata <span className="text-sm text-[#386861] ml-2">Leave a Review</span>
    </h3>
    ...
    <p className="text-gray-700 text-sm mt-3">
      ...
      <a href="#" className="text-[#386861] font-medium ml-1">Learn More About Ayata</a>
    </p>
    <button className="mt-4 inline-block px-5 py-2 bg-gray-100 text-sm font-medium text-gray-800 rounded-full border hover:bg-gray-200 transition">Visit Product Profile</button>
  </div>
  ...
  <div className="bg-white p-6 rounded-xl border shadow-sm">
    ...
    <h3 className="text-lg font-semibold text-gray-800 mt-2">
      BigBI Software <span className="text-sm text-[#386861]ml-2">Leave a Review</span>
    </h3>
    ...
    <p className="text-gray-700 text-sm mt-3">
      ...
      <a href="#" className="text-[#386861] font-medium ml-1">Learn More About BigBI Software</a>
    </p>
    <button className="mt-4 inline-block px-5 py-2 bg-gray-100 text-sm font-medium text-gray-800 rounded-full border hover:bg-gray-200 transition">Visit Product Profile</button>
  </div>
</div>
<div className="bg-[#1E2E2B] rounded-3xl p-8 sm:p-12 flex flex-col items-center text-center text-white shadow-md mt-10">
    ...
    <button className="bg-[#386861]   text-white font-semibold text-lg px-6 py-3 rounded-full flex items-center gap-2 transition">
      List Your Product
  ...
  <div className="bg-white border rounded-xl p-6 shadow-sm flex flex-col gap-4 mt-10">
    <div className="flex justify-between items-start">
      ...
      <div className="flex items-center gap-4">
        <a href="#" className="text-[#386861] text-sm">Leave a Review</a>
        <a href="#" className="text-[#386861] font-semibold text-sm">Compare</a>
      </div>
    </div>
    <div>
      ...
      <a href="#" className="text-[#386861] font-semibold text-sm mt-2 inline-block">Learn More About Bilbeo Analytics</a>
    </div>
    <div>
  ...
  <div className="bg-white border rounded-xl p-6 shadow-sm flex flex-col gap-4 mt-10">
    ...
    <div>
      ...
      <a href="#" className="text-[#386861] font-semibold text-sm mt-2 inline-block">Learn More About BIME</a>
    </div>
    <div>
      <button className="mt-2 px-6 py-2 bg-gray-100 rounded-full text-sm font-medium flex items-center gap-2">
        Visit Product Profile
  ...
  <div className="bg-white border rounded-xl p-6 shadow-sm flex flex-col gap-4 mt-10">
    ...
    <div>
      ...
      <a href="#" className="text-[#386861]font-semibold text-sm mt-2 inline-block">Learn More About bipp Analytics</a>
    </div>
    <div>
      <button className="mt-2 px-6 py-2 bg-gray-100 rounded-full text-sm font-medium flex items-center gap-2">
        Visit Product Profile
...
<div className="bg-white border rounded-xl p-6 shadow-sm flex flex-col gap-4 mt-10">
  <div className="flex justify-between items-start">
    ...
    <div className="flex items-center gap-4">
      <span className="text-[#386861] text-sm font-semibold">4.5 (1 review)</span>
      <a href="#" className="text-[#386861] font-semibold text-sm">Compare</a>
    </div>
  </div>
  <div>
    ...
    <a href="#" className="text-[#386861] font-semibold text-sm mt-2 inline-block">Learn More About Birst</a>
  </div>
  <div>
    <button className="mt-2 px-6 py-2 bg-gray-100 rounded-full text-sm font-medium flex items-center gap-2">
      Visit Product Profile
...
<div className="bg-white border rounded-xl p-6 shadow-sm flex flex-col gap-4 mt-10">
  ...
  <div>
    ...
    <p className="text-sm text-gray-700"><strong>Good for:</strong> Medium (250–999 Employees), Enterprise (5,000+ Employees), Large (1,000–4,999 Employees)</p>
    <a href="#" className="text-[#386861]font-semibold text-sm mt-2 inline-block">Learn More About Birt Analytics - Actuate</a>
  </div>
  <div>
    <button className="mt-2 px-6 py-2 bg-gray-100 rounded-full text-sm font-medium flex items-center gap-2">
      Visit Product Profile
