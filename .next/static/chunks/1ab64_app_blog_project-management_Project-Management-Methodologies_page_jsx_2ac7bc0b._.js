...
"[project]/src/app/blog/project-management/Project-Management-Methodologies/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ProjectManagementGuide() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectManagementGuide.useEffect": ()=>{
            const checkMobile = {
                "ProjectManagementGuide.useEffect.checkMobile": ()=>{
            ...
            return ({
                "ProjectManagementGuide.useEffect": ()=>window.removeEventListener("resize", checkMobile)
            })["ProjectManagementGuide.useEffect"];
        }
    }["ProjectManagementGuide.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectManagementGuide.useEffect": ()=>{
            const handleScroll = {
                "ProjectManagementGuide.useEffect.handleScroll": ()=>{
                    const sections = document.querySelectorAll("section[id]");
                    const scrollPosition = window.scrollY + 100;
                    sections.forEach({
                        "ProjectManagementGuide.useEffect.handleScroll": (section)=>{
                            const sectionTop = section.offsetTop;
                            const sectionHeight = section.clientHeight;
                            const sectionId = section.getAttribute("id");
                            if (scrollPosition >= sectionTop && scrollPosition < sectionTop + sectionHeight) {
                                setTableOfContents({
                                    "ProjectManagementGuide.useEffect.handleScroll": (prev)=>prev.map({
                                            "ProjectManagementGuide.useEffect.handleScroll": (item)=>({
                                                    ...item,
            ...
            return ({
                "ProjectManagementGuide.useEffect": ()=>window.removeEventListener("scroll", handleScroll)
            })["ProjectManagementGuide.useEffect"];
        }
    }["ProjectManagementGuide.useEffect"], []);
    const faqData = [
...
_s(ProjectManagementGuide, "+3PjH+ZBPD2Abj2XVwlVRjheB68=");
_c = ProjectManagementGuide;
var _c;
__turbopack_context__.k.register(_c, "ProjectManagementGuide");
...
//# sourceMappingURL=1ab64_app_blog_project-management_Project-Management-Methodologies_page_jsx_2ac7bc0b._.js.map